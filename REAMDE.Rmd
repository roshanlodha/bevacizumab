---
title: "Molecular Phenotype of Bevacizumab Responders"
subtitle: "Tumors that respond poorly to bevacizumab therapy show upregulation of angiogenesis genes in glioblastoma."
author: "Roshan Lodha"
date: "`r Sys.Date()`"
...
### DeSeq Exploration
#### KDR
``` {r KDR, eval = FALSE, echo = FALSE, include = FALSE}
...
``` {r kdr-heatamp, eval = FALSE, echo = FALSE, include = FALSE}
goi <- kdr$gene

...
ggsave("../plots/ihc/egr1poorgood.svg", height = 6, width = 8)
...
ggsave("../plots/ihc/egr1poorplacebonuc.svg", height = 6, width = 8)
...
ggplot(egr1.poor.placebo %>% dplyr::filter(staining_type == "cytoplasmic"),
  ...
  xlab("Treatment Group") + ylab("Expression (H Score)")
ggsave("../plots/ihc/egr1poorplacebocyto.svg", height = 6, width = 8)